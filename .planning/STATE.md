...
| 260318-eax | Breaking change: remove master_key from settings API/storage, use keyring-only MasterKeyProvider with backend+frontend+tests updates | 2026-03-18 | c283103 | [260318-eax-breaking-change-remove-master-key-from-s](./quick/260318-eax-breaking-change-remove-master-key-from-s/) |
