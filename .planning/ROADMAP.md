...
Plans:
- [ ] 03-01-PLAN.md — OAuth state binding hardening and interact source isolation
- [ ] 03-02-PLAN.md — HTTP/script/parser boundary hardening for SSRF/RCE risk reduction
- [ ] 03-03-PLAN.md — Central redaction plus internal scraper/file API confidentiality hardening
